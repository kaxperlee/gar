        ...
        <div class="tab-content mt-3" id="myTabContent">
            <div class="tab-pane fade show active" id="home-tab-pane" role="tabpanel" aria-labelledby="exp-tab" tabindex="0">
                <div class="d-flex mb-3" style='width:100%;background-color:white'>
                    <x-cab3 texto="{{$seguimientos->Delito}}" />
                ...
                <div class="row">
                    ...
                    <div class="col-3 my-2">
                        ...
                        <input  class="form-control" type="text" name="epigrafe" value="{{$seguimientos->id}}" readonly>
                    </div>
                    <div class="col-3 my-2">
                        <label for="fecha">Fecha (dd/mm/aaaa)</label><br>
                        <input class="form-control" type="date" name="fecha" value="{{$seguimientos->id}}" readonly>
                    </div>
                    <div class="col-3 my-2">
                        <label for="caracter">Caracter</label><br>
                        <input class="form-control" type="text" name="fecha" value="{{$seguimientos->id}}" readonly>
                    </div>
                    <div class="col-12 my-2">
                        <label for="Codigo">Codigo</label><br>
                        <input class="form-control" widt="100%" type="text" name="Codigo"  value="" readonly>
                    </div>
                    <div class="col-6 my-2">
                        <label for="descripcion">Descripción:</label><br>
                        <textarea style='resize: none;' name="descripcion" class="form-control" id="descripcion" rows="3"  readonly></textarea>

                    </div>
                    <div class="col-6 my-2">
                        <label for="riesgoa">Riesgo afectado / Conducta delictiva:</label><br>
                        <textarea style='resize: none;' name="riesgoa" class="form-control" id="riesgoa" rows="3" readonly></textarea>
                    </div>

                    <div class="col-6 my-2">
                        <label for="informara">Informar a:</label><br>
                        <input class="form-control" type="text" name="informara"  value="" readonly >
                    </div>
                    <div class="col-6 my-2">
                        <label for="remitente">Remitente:</label><br>
                        <input class="form-control" type="text" name="remitente"  value="" readonly >
                    </div>
                    ...
                    <div class="col-3 my-2">
                        ...
                        <input class="form-control" type="date" name="fechat"  value="" readonly >
                    </div>
                    <div class="col-3 my-2">
                        <label for="propuesta">Propuesta:</label><br>
                        <input class="form-control" type="text" name="propuesta"  value="" readonly >
                    </div>
                    <div class="col-3 my-2">
                        <label for="nivelrp">Nivel de riesgo penal:</label><br>
                        <input class="form-control" type="text" name="nivelrp"  value="" readonly >
                    </div>
                    <div class="col-6 my-2">
                        <label for="comunicara">Comunicar a autoridades:</label><br>
                        <textarea style='resize: none;' name="comunicara" class="form-control" id="comunicara" rows="3" readonly></textarea>

                    </div>
                    <div class="col-6 my-2">
                        <label for="autoria">Autoría:</label><br>
                        <textarea style='resize: none;' name="autoria" class="form-control" id="autoria" rows="3" readonly></textarea>
                    </div>
                    <div class="col-6 my-2">
                        <label for="observaciones">Observaciones:</label><br>
                        <textarea style='resize: none;' name="observaciones" class="form-control" id="observaciones" rows="3" readonly></textarea>

                    </div>
                    <div class="col-6 my-2">
                        <label for="propuestas">Propuestas:</label><br>
                        <textarea style='resize: none;' name="propuestas" class="form-control" id="propuestas" rows="3" readonly></textarea>
                    </div>
            ...
            <div class="tab-pane fade" id="profile-tab-pane" role="tabpanel" aria-labelledby="actividad-tab" tabindex="0">
                ...
                <div class="px-3 mb-5">
                    <div class="container-fluid">
                        <div class="row">
                        @foreach ($seguimientos->Riesgos as $riesgo)
                            <div class="col-12 mt-3"><a href="{{route('riesgos.show',$riesgo->id)}}"><strong> - </strong>{{$riesgo->Nombre}}</a></div>
                            <div class="col-1">Estado: @if ($riesgo->Estado == 'checked') <i class=" text-success fa-solid fa-check"></i>@endif </label><br></div>
                        @endforeach
                        </div>
                    </div>
                </div>
            ...
            <div class="tab-pane fade" id="contact-tab-pane" role="tabpanel" aria-labelledby="control-tab" tabindex="0">
                ...
                <div class="px-3 mb-5">
                    <div class="container-fluid">
                        <div class="row">
                        @foreach ($seguimientos->Controls as $control)
